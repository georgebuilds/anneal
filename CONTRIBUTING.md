...
1. **Stay in scope.** v1 is intentionally bounded (static shapes, single device, WebGPU, no JIT/BEAM/symbolic — see the README status table). PRs that pull deferred features forward will likely be declined unless they've been discussed first.
